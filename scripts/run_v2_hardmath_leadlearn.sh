#!/bin/bash
#SBATCH -J evopool_v2_hardmath_leadlearn
#SBATCH -A hw-grp
...
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/v2_hardmath_leadlearn_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/v2_hardmath_leadlearn_%j.err

echo "=== v2_hardmath_leadlearn (with leader learning) ==="
...
mkdir -p results/v2_hardmath_leadlearn
...
python -u run_experiment.py \
    ...
    --seed 42 \
    --output_dir results/v2_hardmath_leadlearn/

echo "=== Done: v2_hardmath_leadlearn | $(date) ==="
