...
#SBATCH --mem=32G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/e52_memcollab_aime_think2_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/e52_memcollab_aime_think2_%j.err

# E52: MemCollab on Hard Math Stream (thinking=True)
# Thinking mode ENABLED — required for AIME (long reasoning chains)
echo "=== E52: MemCollab on Hard Math Stream (thinking=True) ==="
