#!/bin/bash
#SBATCH -J evopool_e38_evomem_aime
#SBATCH -A hw-grp
#SBATCH -p hw-grp
#SBATCH --gres=gpu:0
#SBATCH -t 5:00:00
#SBATCH --mem=32G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/e38_evomem_aime_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/e38_evomem_aime_%j.err

# E38: EvoMem on Hard Math Stream (AIME)
# Key question: does individual self-reflection memory help on hard math?
# Compare vs E29 (EvoPool-full AIME) - if gap is large → CoDream is critical at high difficulty
echo "=== E38: EvoMem (individual evolving memory) on Hard Math Stream ==="
...
python -u run_experiment.py \
    ...
    --output_dir results/e38/

echo "=== Done: EvoMem AIME | $(date) ==="
