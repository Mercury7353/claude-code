#!/bin/bash
#SBATCH -J rerun_hardcode_memcollab
#SBATCH -A hw-grp
...
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/rerun_hardcode_memcollab_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/rerun_hardcode_memcollab_%j.err

echo "=== rerun_hardcode_memcollab (MBPP fix) ==="
...
mkdir -p results/v2_hardcode_memcollab_rerun
...
python -u run_experiment.py \
    ...
    --seed 42 \
    --output_dir results/v2_hardcode_memcollab_rerun/

echo "=== Done: rerun_hardcode_memcollab | $(date) ==="
