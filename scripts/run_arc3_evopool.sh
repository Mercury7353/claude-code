...
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/arc3_evopool_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/arc3_evopool_%j.err
...
python3 -u run_arc_agi3.py \
    ...
    --warmup_plays 30 \
    --seed 42 \
    --games "r11l,vc33,cd82,sb26,ft09,sc25,tn36,tr87,tu93,ls20,bp35,su15,ar25,sp80,lp85,g50t,s5i5,sk48,cn04,ka59,m0r0,re86,dc22,lf52,wa30" --output_dir results/arc3/ 

echo "=== Done: arc3_evopool | $(date) ==="
