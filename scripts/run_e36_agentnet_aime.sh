#!/bin/bash
#SBATCH -J evopool_e36_agentnet_aime
#SBATCH -A hw-grp
#SBATCH -p hw-grp
#SBATCH --gres=gpu:0
#SBATCH -t 4:00:00
#SBATCH --mem=32G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/e36_agentnet_aime_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/e36_agentnet_aime_%j.err

# E36: AgentNet on Hard Math Stream (AIME)
# Key question: does per-agent RAG memory help on hard math?
# Compare vs E29 (EvoPool-full) and E30 (single-agent)
echo "=== E36: AgentNet on Hard Math Stream ==="
...
python -u run_experiment.py \
    ...
    --output_dir results/e36/

echo "=== Done: AgentNet AIME | $(date) ==="
