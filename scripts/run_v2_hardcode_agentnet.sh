#!/bin/bash
#SBATCH -J evopool_v2_hardcode_agentnet
#SBATCH -A hw-grp
...
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/v2_hardcode_agentnet_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/v2_hardcode_agentnet_%j.err

echo "=== v2_hardcode_agentnet ==="
...
mkdir -p results/v2_hardcode_agentnet
...
python -u run_experiment.py \
    ...
    --seed 42 \
    --output_dir results/v2_hardcode_agentnet/ 

echo "=== Done: v2_hardcode_agentnet | $(date) ==="
