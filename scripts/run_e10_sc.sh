...
#SBATCH --mem=32G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/e10_sc_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/e10_sc_%j.err

# E10: Self-Consistency rerun with long-lived servers (4/5 on ports 8003/8004)
echo "=== EvoPool E10 Self-Consistency (100 tasks/domain) ==="
...
echo "=== Done: self_consistency | $(date) ==="
