...
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/v2_dylan_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/v2_dylan_%j.err
...
python -u run_experiment.py \
    ...
    --seed 42 \
    --output_dir results/v2_dylan/ 

echo "=== Done: v2_dylan | $(date) ==="
