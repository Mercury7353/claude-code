#!/bin/bash
#SBATCH -J evopool_e48_nolifecycle_aime
#SBATCH -A hw-grp
#SBATCH -p hw-grp
#SBATCH --gres=gpu:0
#SBATCH -t 10:00:00
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/e48_nolifecycle_aime_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/e48_nolifecycle_aime_%j.err

# E48: EvoPool-noLifecycle on Hard Math Stream (thinking=True)
echo "=== E48: EvoPool-noLifecycle on Hard Math Stream (thinking=True) ==="
