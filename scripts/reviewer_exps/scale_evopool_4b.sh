...
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -o logs/scale_evopool_4b_%j.out
#SBATCH -e logs/scale_evopool_4b_%j.err

echo "=== scale_evopool_4b: evopool_full with Qwen3-4B ==="
...
mkdir -p results/scale_evopool_4b
...
python -u run_experiment.py \
    ...
    --seed 42 \
    --output_dir results/scale_evopool_4b/

echo "=== Done: scale_evopool_4b | $(date) ==="
