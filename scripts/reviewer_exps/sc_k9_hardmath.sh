...
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -J sc_k9_hmath
#SBATCH -o logs/sc_k9_hmath_%j.out
#SBATCH -e logs/sc_k9_hmath_%j.err
echo "=== SC k=9 compute-matched baseline ==="
...
mkdir -p results/sc_k9_hardmath
python -u run_experiment.py \
    ...
    --output_dir results/sc_k9_hardmath/
echo "=== Done: sc_k9 | $(date) ==="
