...
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -o logs/scale_sa_14b_%j.out
#SBATCH -e logs/scale_sa_14b_%j.err

echo "=== scale_sa_14b: single_agent with Qwen3-14B ==="
...
python -u run_experiment.py \
    ...
    --seed 42 \
    --output_dir results/scale_sa_14b/

echo "=== Done: scale_sa_14b | $(date) ==="
