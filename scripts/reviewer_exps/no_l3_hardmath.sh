...
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -J no_l3_hmath
#SBATCH -o logs/no_l3_hmath_%j.out
#SBATCH -e logs/no_l3_hmath_%j.err
echo "=== EvoPool no L3 broadcast ==="
...
mkdir -p results/no_l3_hardmath
python -u run_experiment.py \
    ...
    --output_dir results/no_l3_hardmath/
echo "=== Done: no_l3 | $(date) ==="
