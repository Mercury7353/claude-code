...
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -J uniform_hmath
#SBATCH -o logs/uniform_hmath_%j.out
#SBATCH -e logs/uniform_hmath_%j.err
echo "=== EvoPool uniform execution (SC for all) ==="
...
mkdir -p results/uniform_exec_hardmath
python -u run_experiment.py \
    --condition "evopool_full" --uniform_execution \
    ...
    --output_dir results/uniform_exec_hardmath/
echo "=== Done: uniform_exec | $(date) ==="
