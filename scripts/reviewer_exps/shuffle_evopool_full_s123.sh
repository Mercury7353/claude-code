...
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -J shuffle_evopool_full_s123
#SBATCH -o logs/shuffle_evopool_full_s123_%j.out
#SBATCH -e logs/shuffle_evopool_full_s123_%j.err
echo "=== shuffle_evopool_full_s123 ==="
...
mkdir -p results/shuffle_evopool_full_s123
python -u run_experiment.py \
    ...
    --output_dir results/shuffle_evopool_full_s123/
echo "=== Done: shuffle_evopool_full_s123 | $(date) ==="
