...
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/v3_hardcode_nocd_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/v3_hardcode_nocd_%j.err

echo "=== v3_hardcode_nocd: Full hardcode noCoDream with CC prompt fix ==="
...
mkdir -p results/v3_hardcode_nocd
...
python -u run_experiment.py \
    ...
    --seed 42 \
    --output_dir results/v3_hardcode_nocd/

echo "=== Done: v3_hardcode_nocd | $(date) ==="
