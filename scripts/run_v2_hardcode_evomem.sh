#!/bin/bash
#SBATCH -J evopool_v2_hardcode_evomem
#SBATCH -A hw-grp
...
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/v2_hardcode_evomem_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/v2_hardcode_evomem_%j.err

echo "=== v2_hardcode_evomem ==="
...
mkdir -p results/v2_hardcode_evomem
...
python -u run_experiment.py \
    ...
    --seed 42 \
    --output_dir results/v2_hardcode_evomem/ 

echo "=== Done: v2_hardcode_evomem | $(date) ==="
