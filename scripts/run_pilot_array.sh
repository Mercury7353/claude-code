...
#SBATCH -c 4
#SBATCH --array=0-3
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/pilot_%A_%a.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/pilot_%A_%a.err
#SBATCH --mail-type=END,FAIL

CONDITIONS=("evopool_full" "evopool_no_codream" "dylan" "agentnet")
COND=${CONDITIONS[$SLURM_ARRAY_TASK_ID]}

echo "=== EvoPool Pilot: $COND ==="
