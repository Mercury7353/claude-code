#!/bin/bash
#SBATCH -J evopool_v2_hardcode_sa
#SBATCH -A hw-grp
...
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/v2_hardcode_sa_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/v2_hardcode_sa_%j.err
...
mkdir -p results/v2_hardcode_sa
...
python -u run_experiment.py \
    ...
    --output_dir results/v2_hardcode_sa/ --pool_size 1 --team_size 1

echo "=== Done: v2_hardcode_sa | $(date) ==="
