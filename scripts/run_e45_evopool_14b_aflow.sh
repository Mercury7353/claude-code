#!/bin/bash
#SBATCH -J evopool_e45_evopool_14b_aflow
#SBATCH -A hw-grp
#SBATCH -p hw-grp
#SBATCH --gres=gpu:0
#SBATCH -t 12:00:00
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/e45_evopool_14b_aflow_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/e45_evopool_14b_aflow_%j.err

# E45: EvoPool-full on AFlow-Stream (Qwen3-14B backbone)
echo "=== E45: EvoPool-full on AFlow-Stream (Qwen3-14B backbone) ==="
...
python -u run_experiment.py \
    ...
    --seed 42 \
    \
    --output_dir results/e45/

echo "=== Done: EvoPool-full on AFlow-Stream (Qwen3-14B backbone) | $(date) ==="
