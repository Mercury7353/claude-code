...
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/e15b_no_codream_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/e15b_no_codream_%j.err

# E15b: EvoPool no-CoDream ablation rerun (E15 OOM killed at task 250 due to node sharing)
# Increased mem to 64G. Ablation baseline for paper: shows benefit of CoDream.
# Uses servers 6/7 (expire ~1PM).
echo "=== EvoPool E15b no-CoDream ablation (rerun with 64G) ==="
