...
#SBATCH -c 4
#SBATCH --array=0-3%4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/e5j_%A_%a.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/e5j_%A_%a.err

# E5j: Fix truncated thinking + "Return ONLY code" prompt
# Testing seeds 42 and 456 (largest HumanEval gaps vs AFlow)
# 2 conditions x 2 seeds = 4 jobs
CONDITIONS=(
    "evopool_no_codream"
    "evopool_full"
)
...
echo "=== EvoPool E5j (truncated-think fix + Return-ONLY-code prompt) ==="
