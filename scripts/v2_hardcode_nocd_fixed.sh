...
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/v2_hardcode_nocd_fixed_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/v2_hardcode_nocd_fixed_%j.err

echo "=== v2_hardcode_nocd_fixed (noCoDream + test cases fix) ==="
...
mkdir -p results/v2_hardcode_nocd_fixed
...
python -u run_experiment.py \
    ...
    --seed 42 \
    --output_dir results/v2_hardcode_nocd_fixed/

echo "=== Done: v2_hardcode_nocd_fixed | $(date) ==="
