#!/bin/bash
#SBATCH -J evopool_e50_noverify_aime
#SBATCH -A hw-grp
#SBATCH -p hw-grp
#SBATCH --gres=gpu:0
#SBATCH -t 10:00:00
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/e50_noverify_aime_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/e50_noverify_aime_%j.err

# E50: EvoPool-noVerify on Hard Math Stream (thinking=True)
echo "=== E50: EvoPool-noVerify on Hard Math Stream (thinking=True) ==="
...
python -u run_experiment.py \
    ...
    --output_dir results/e50/

echo "=== Done: EvoPool-noVerify on Hard Math Stream (thinking=True) | $(date) ==="
