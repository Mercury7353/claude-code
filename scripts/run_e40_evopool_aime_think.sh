...
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/e40_evopool_aime_think_%j.err

# E40: EvoPool-full on Hard Math Stream (thinking=True)
# Thinking mode ENABLED — required for AIME (long reasoning chains)
echo "=== E40: EvoPool-full on Hard Math Stream (thinking=True) ==="
...
python -u run_experiment.py \
    ...
    --output_dir results/e40/

echo "=== Done: EvoPool-full on Hard Math Stream (thinking=True) | $(date) ==="
