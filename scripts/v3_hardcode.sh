...
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/v3_hardcode_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/v3_hardcode_%j.err

echo "=== v3_hardcode: Full hardcode with CC prompt fix ==="
...
python -u run_experiment.py \
    ...
    --seed 42 \
    --output_dir results/v3_hardcode/

echo "=== Done: v3_hardcode | $(date) ==="
