#!/bin/bash
#SBATCH -J evopool_e46_single_14b_aflow
#SBATCH -A hw-grp
#SBATCH -p hw-grp
#SBATCH --gres=gpu:0
#SBATCH -t 8:00:00
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/e46_single_14b_aflow_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/e46_single_14b_aflow_%j.err

# E46: Single-agent on AFlow-Stream (Qwen3-14B backbone)
echo "=== E46: Single-agent on AFlow-Stream (Qwen3-14B backbone) ==="
...
python -u run_experiment.py \
    ...
    --seed 42 \
    \
    --output_dir results/e46/

echo "=== Done: Single-agent on AFlow-Stream (Qwen3-14B backbone) | $(date) ==="
