#!/bin/bash
#SBATCH -J evopool_v2_hardmath_evomem
#SBATCH -A hw-grp
...
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/v2_hardmath_evomem_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/v2_hardmath_evomem_%j.err

echo "=== v2_hardmath_evomem ==="
...
mkdir -p results/v2_hardmath_evomem
...
python -u run_experiment.py \
    ...
    --seed 42 \
    --output_dir results/v2_hardmath_evomem/ 

echo "=== Done: v2_hardmath_evomem | $(date) ==="
