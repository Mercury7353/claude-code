...
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/e41_nocd_aime_think_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/e41_nocd_aime_think_%j.err

# E41: EvoPool-noCoDream on Hard Math Stream (thinking=True)
# Thinking mode ENABLED — required for AIME (long reasoning chains)
echo "=== E41: EvoPool-noCoDream on Hard Math Stream (thinking=True) ==="
...
python -u run_experiment.py \
    ...
    --output_dir results/e41/

echo "=== Done: EvoPool-noCoDream on Hard Math Stream (thinking=True) | $(date) ==="
