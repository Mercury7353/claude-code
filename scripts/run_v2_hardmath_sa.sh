#!/bin/bash
#SBATCH -J evopool_v2_hardmath_sa
#SBATCH -A hw-grp
...
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/v2_hardmath_sa_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/v2_hardmath_sa_%j.err
...
mkdir -p results/v2_hardmath_sa
...
python -u run_experiment.py \
    ...
    --seed 42 \
    --output_dir results/v2_hardmath_sa/ --pool_size 1 --team_size 1 --benchmark hard_math_stream --n_per_domain all --domains math_hard,aime_2022,aime_2023,aime_2024,aime_2025

echo "=== Done: v2_hardmath_sa | $(date) ==="
