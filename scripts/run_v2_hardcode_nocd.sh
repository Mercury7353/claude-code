#!/bin/bash
#SBATCH -J evopool_v2_hardcode_nocd
#SBATCH -A hw-grp
...
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/v2_hardcode_nocd_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/v2_hardcode_nocd_%j.err

echo "=== v2_hardcode_nocd ==="
...
mkdir -p results/v2_hardcode_nocd
...
python -u run_experiment.py \
    ...
    --output_dir results/v2_hardcode_nocd/ 

echo "=== Done: v2_hardcode_nocd | $(date) ==="
