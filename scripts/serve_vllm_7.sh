...
#SBATCH --mem=48G
#SBATCH -c 8
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/vllm7_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/vllm7_%j.err

MODEL_PATH="/nfs/hpc/share/zhanyaol/models/Qwen3-8B"
PORT=8006
SERVER_FILE="/nfs/hpc/share/zhanyaol/claude-code/vllm_server_7.json"
