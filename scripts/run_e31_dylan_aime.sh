#!/bin/bash
#SBATCH -J evopool_e31_dylan_aime
#SBATCH -A hw-grp
#SBATCH -p hw-grp
#SBATCH --gres=gpu:0
#SBATCH -t 4:00:00
#SBATCH --mem=32G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/e31_dylan_aime_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/e31_dylan_aime_%j.err

# E31: DyLAN baseline on Hard Math Stream
# Compare: E29 (EvoPool-full) vs E31 (DyLAN) vs E30 (single) on AIME
echo "=== E31: DyLAN on Hard Math Stream ==="
...
python -u run_experiment.py \
    ...
    --output_dir results/e31/

echo "=== Done: DyLAN AIME | $(date) ==="
