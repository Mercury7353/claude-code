#!/bin/bash
#SBATCH -J evopool_e55b_reverse_sa
#SBATCH -A hw-grp
...
#SBATCH --mem=32G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/e55b_reverse_sa_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/e55b_reverse_sa_%j.err

# E55b: Single-Agent baseline for reverse order
echo "=== E55b: Single-Agent REVERSE order ==="
...
python -u run_experiment.py \
    ...
    --seed 42 \
    --domains "aime_2025,aime_2024,aime_2023,aime_2022,math_hard" \
    --output_dir results/e55b/

echo "=== Done: E55b Single-Agent REVERSE | $(date) ==="
