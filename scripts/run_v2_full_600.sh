...
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/v2_full_600_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/v2_full_600_%j.err

echo "=== v2_full_600 (600 tasks) ==="
...
python -u run_experiment.py \
    ...
    --seed 42 \
    --output_dir results/v2_full_600/ 

echo "=== Done: v2_full_600 | $(date) ==="
