#!/bin/bash
#SBATCH -J evopool_e33_memcollab
#SBATCH -A hw-grp
#SBATCH -p hw-grp
#SBATCH --gres=gpu:0
#SBATCH -t 6:00:00
#SBATCH --mem=32G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/e33_memcollab_aflow_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/e33_memcollab_aflow_%j.err

# E33: MemCollab baseline on AFlow-Stream
# MemCollab (arXiv 2603.23234): contrastive trajectory distillation → shared flat memory
# Compare vs E17 (EvoPool-full) and E15b (EvoPool-noCoDream) on 6-domain stream
echo "=== E33: MemCollab on AFlow-Stream ==="
...
python -u run_experiment.py \
    ...
    --seed 42 \
    --output_dir results/e33/

echo "=== Done: MemCollab AFlow | $(date) ==="
