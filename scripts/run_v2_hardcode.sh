...
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/v2_hardcode_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/v2_hardcode_%j.err
...
python -u run_experiment.py \
    ...
    --output_dir results/v2_hardcode/ 

echo "=== Done: v2_hardcode | $(date) ==="
