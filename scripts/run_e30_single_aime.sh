#!/bin/bash
#SBATCH -J evopool_e30_single_aime
#SBATCH -A hw-grp
#SBATCH -p hw-grp
#SBATCH --gres=gpu:0
#SBATCH -t 4:00:00
#SBATCH --mem=32G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/e30_single_aime_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/e30_single_aime_%j.err

# E30: Single-agent baseline on Hard Math Stream
# Lower bound: what does a single Qwen3-8B get on AIME without any pool/CoDream?
echo "=== E30: Single-Agent on Hard Math Stream ==="
...
python -u run_experiment.py \
    ...
    --output_dir results/e30/

echo "=== Done: Single-Agent AIME | $(date) ==="
