#!/bin/bash
#SBATCH -J v2_hardmath_nocd_fixed
#SBATCH -A hw-grp
...
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/v2_hardmath_nocd_fixed_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/v2_hardmath_nocd_fixed_%j.err

echo "=== v2_hardmath_nocd_fixed (experience transfer fix, no CoDream) ==="
...
mkdir -p results/v2_hardmath_nocd_fixed
...
python -u run_experiment.py \
    ...
    --seed 42 \
    --output_dir results/v2_hardmath_nocd_fixed/

echo "=== Done: v2_hardmath_nocd_fixed | $(date) ==="
