...
#SBATCH --mem=32G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/e17_fix2c_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/e17_fix2c_%j.err

# E17 (fix2 corrected — removed QA hint): EvoPool full + Fix1 + Fix2 (cross-agent general insight sharing + working memory)
