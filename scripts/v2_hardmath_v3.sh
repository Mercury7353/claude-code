...
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/v2_hardmath_v3_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/v2_hardmath_v3_%j.err

echo "=== v2_hardmath_v3: all fixes (max_tokens=7000 + retry + evaluator + exp transfer) ==="
...
mkdir -p results/v2_hardmath_v3
...
python -u run_experiment.py \
    ...
    --seed 42 \
    --output_dir results/v2_hardmath_v3/
