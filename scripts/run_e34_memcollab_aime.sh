#!/bin/bash
#SBATCH -J evopool_e34_memcollab_aime
#SBATCH -A hw-grp
#SBATCH -p hw-grp
#SBATCH --gres=gpu:0
#SBATCH -t 4:00:00
#SBATCH --mem=32G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/e34_memcollab_aime_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/e34_memcollab_aime_%j.err

# E34: MemCollab baseline on Hard Math Stream (AIME)
# Key question: does MemCollab's flat shared memory also improve on hard math?
# Compare vs E29 (EvoPool-full AIME) and E30 (single-agent AIME)
echo "=== E34: MemCollab on Hard Math Stream ==="
...
python -u run_experiment.py \
    ...
    --output_dir results/e34/

echo "=== Done: MemCollab AIME | $(date) ==="
