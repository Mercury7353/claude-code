...
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -J ms_memcollab_s7
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/ms_memcollab_s7_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/ms_memcollab_s7_%j.err

echo "=== ms_memcollab_s7: memcollab seed=7 ==="
...
mkdir -p results/ms_memcollab_s7
...
python -u run_experiment.py \
    ...
    --seed 7  \
    --output_dir results/ms_memcollab_s7/

echo "=== Done: ms_memcollab_s7 | $(date) ==="
