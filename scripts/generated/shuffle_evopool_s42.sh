...
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -J shuffle_evopool_s42
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/shuffle_evopool_s42_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/shuffle_evopool_s42_%j.err

echo "=== shuffle_evopool_s42: evopool SHUFFLED ordering ==="
...
mkdir -p results/shuffle_evopool_s42
...
python -u run_experiment.py \
    ...
    --seed 42 --shuffle_all \
    --output_dir results/shuffle_evopool_s42/

echo "=== Done: shuffle_evopool_s42 | $(date) ==="
