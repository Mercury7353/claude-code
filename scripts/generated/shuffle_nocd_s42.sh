...
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -J shuffle_nocd_s42
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/shuffle_nocd_s42_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/shuffle_nocd_s42_%j.err

echo "=== shuffle_nocd_s42: nocd SHUFFLED ordering ==="
...
mkdir -p results/shuffle_nocd_s42
...
python -u run_experiment.py \
    ...
    --seed 42 --shuffle_all \
    --output_dir results/shuffle_nocd_s42/

echo "=== Done: shuffle_nocd_s42 | $(date) ==="
