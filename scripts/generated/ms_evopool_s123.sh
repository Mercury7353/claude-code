...
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -J ms_evopool_s123
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/ms_evopool_s123_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/ms_evopool_s123_%j.err

echo "=== ms_evopool_s123: evopool seed=123 ==="
...
mkdir -p results/ms_evopool_s123
...
python -u run_experiment.py \
    ...
    --seed 123  \
    --output_dir results/ms_evopool_s123/

echo "=== Done: ms_evopool_s123 | $(date) ==="
