...
#SBATCH -c 4
#SBATCH -J ms_nocd_s7
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/ms_nocd_s7_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/ms_nocd_s7_%j.err

echo "=== ms_nocd_s7: nocd seed=7 ==="
...
python -u run_experiment.py \
    ...
    --seed 7  \
    --output_dir results/ms_nocd_s7/

echo "=== Done: ms_nocd_s7 | $(date) ==="
