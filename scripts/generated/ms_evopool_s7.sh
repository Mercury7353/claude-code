...
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -J ms_evopool_s7
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/ms_evopool_s7_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/ms_evopool_s7_%j.err

echo "=== ms_evopool_s7: evopool seed=7 ==="
...
python -u run_experiment.py \
    ...
    --seed 7  \
    --output_dir results/ms_evopool_s7/

echo "=== Done: ms_evopool_s7 | $(date) ==="
