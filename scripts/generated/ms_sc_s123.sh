...
#SBATCH -c 4
#SBATCH -J ms_sc_s123
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/ms_sc_s123_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/ms_sc_s123_%j.err

echo "=== ms_sc_s123: sc seed=123 ==="
...
python -u run_experiment.py \
    ...
    --seed 123  \
    --output_dir results/ms_sc_s123/

echo "=== Done: ms_sc_s123 | $(date) ==="
