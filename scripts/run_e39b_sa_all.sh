...
#SBATCH --mem=32G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/e39b_sa_all_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/e39b_sa_all_%j.err

echo "=== E39b: Single-Agent ALL tasks ==="
...
python -u run_experiment.py \
    ...
    --output_dir results/e39b/

echo "=== Done: E39b Single-Agent ALL | $(date) ==="
