#!/bin/bash
#SBATCH -J evopool_v2_hardcode_memcollab
#SBATCH -A hw-grp
...
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/v2_hardcode_memcollab_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/v2_hardcode_memcollab_%j.err

echo "=== v2_hardcode_memcollab ==="
...
mkdir -p results/v2_hardcode_memcollab
...
python -u run_experiment.py \
    ...
    --seed 42 \
    --output_dir results/v2_hardcode_memcollab/ 

echo "=== Done: v2_hardcode_memcollab | $(date) ==="
