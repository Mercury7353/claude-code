#!/bin/bash
#SBATCH -J evopool_e49_nol2_aime
#SBATCH -A hw-grp
#SBATCH -p hw-grp
#SBATCH --gres=gpu:0
#SBATCH -t 10:00:00
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/e49_nol2_aime_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/e49_nol2_aime_%j.err

# E49: EvoPool-noL2 on Hard Math Stream (thinking=True)
echo "=== E49: EvoPool-noL2 on Hard Math Stream (thinking=True) ==="
...
python -u run_experiment.py \
    ...
    --output_dir results/e49/

echo "=== Done: EvoPool-noL2 on Hard Math Stream (thinking=True) | $(date) ==="
