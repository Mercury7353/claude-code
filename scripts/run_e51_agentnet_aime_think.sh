...
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/e51_agentnet_aime_think_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/e51_agentnet_aime_think_%j.err

# E51: AgentNet on Hard Math Stream (thinking=True)
# RAG-based per-agent memory, no cross-agent sharing, with thinking enabled
# Matches E36 but with thinking mode for fair comparison with E40-E44
echo "=== E51: AgentNet on Hard Math Stream (thinking=True) ==="
...
python -u run_experiment.py \
    ...
    --output_dir results/e51/

echo "=== Done: AgentNet AIME (thinking=True) | $(date) ==="
