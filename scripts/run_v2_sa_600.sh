...
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/v2_sa_600_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/v2_sa_600_%j.err

echo "=== v2_sa_600 (600 tasks) ==="
...
python -u run_experiment.py \
    ...
    --seed 42 \
    --output_dir results/v2_sa_600/ --pool_size 1 --team_size 1

echo "=== Done: v2_sa_600 | $(date) ==="
