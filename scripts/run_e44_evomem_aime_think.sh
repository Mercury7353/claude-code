#!/bin/bash
#SBATCH -J evopool_e44_evomem_aime_think
#SBATCH -A hw-grp
#SBATCH -p hw-grp
#SBATCH --gres=gpu:0
#SBATCH -t 8:00:00
#SBATCH --mem=32G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/e44_evomem_aime_think_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/e44_evomem_aime_think_%j.err

# E44: EvoMem on Hard Math Stream (thinking=True)
# Thinking mode ENABLED — required for AIME (long reasoning chains)
echo "=== E44: EvoMem on Hard Math Stream (thinking=True) ==="
