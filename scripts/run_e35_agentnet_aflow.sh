...
#SBATCH --mem=32G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/e35_agentnet_aflow_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/e35_agentnet_aflow_%j.err

# E35: AgentNet baseline on AFlow-Stream
# AgentNet (NeurIPS 2025, arXiv 2504.00587): per-agent RAG memory + DAG topology
# Compare vs E17 (EvoPool), E13 (DyLAN), E18 (single-agent) on 6-domain stream
echo "=== E35: AgentNet on AFlow-Stream ==="
...
python -u run_experiment.py \
    ...
    --seed 42 \
    --output_dir results/e35/

echo "=== Done: AgentNet AFlow | $(date) ==="
