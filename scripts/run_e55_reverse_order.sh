#!/bin/bash
#SBATCH -J evopool_e55_reverse_order
#SBATCH -A hw-grp
...
#SBATCH --mem=64G
#SBATCH -c 4
#SBATCH -o /nfs/hpc/share/zhanyaol/claude-code/logs/e55_reverse_order_%j.out
#SBATCH -e /nfs/hpc/share/zhanyaol/claude-code/logs/e55_reverse_order_%j.err

# E55: EvoPool-full, REVERSE domain order (hardest first)
echo "=== E55: EvoPool-full REVERSE order ==="
...
python -u run_experiment.py \
    ...
    --output_dir results/e55/

echo "=== Done: E55 REVERSE order | $(date) ==="
